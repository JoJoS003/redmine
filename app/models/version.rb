...
class Version < ActiveRecord::Base
  ...
  # Returns the remaining time for this version
  # (sum of unclosed issues)
  def remaining_hours
    @remaining_hours ||= fixed_issues.leaves.sum(:estimated_hours, 
        conditions: "closed_on IS NULL").to_f
  end
